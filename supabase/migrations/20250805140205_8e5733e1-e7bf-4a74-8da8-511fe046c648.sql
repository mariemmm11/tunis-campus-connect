...
INSERT INTO public.careers (title, description, sector_id, required_education, salary_range, skills, prospects) VALUES
...
-- Insert sample formations data  
INSERT INTO public.formations (title, description, duration, cost, location, university, sector_id, level, prerequisites, career_prospects) VALUES
-- Informatique & Digital
...
INSERT INTO public.testimonials (nom_etudiant, universite, specialite, contenu, note, sector_id) VALUES
...
-- Add foreign key relationship between careers and sectors
ALTER TABLE public.careers 
ADD CONSTRAINT careers_sector_id_fkey 
FOREIGN KEY (sector_id) REFERENCES public.sectors(id);

-- Add foreign key relationship between formations and sectors  
ALTER TABLE public.formations 
ADD CONSTRAINT formations_sector_id_fkey 
FOREIGN KEY (sector_id) REFERENCES public.sectors(id);

-- Add foreign key relationship between testimonials and sectors
